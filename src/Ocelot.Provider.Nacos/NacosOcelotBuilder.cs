...
{
    public class NacosOcelotBuilder : IOcelotBuilder
    {
        public IServiceCollection Services { get; }
        public IConfiguration Configuration { get; }
        public IMvcCoreBuilder MvcCoreBuilder { get; }

        public NacosOcelotBuilder(IServiceCollection services, IConfiguration configuration, FileConfiguration fileConfiguration)
        {
            Services = services;
            Configuration = configuration;
            services.Configure<FileConfiguration>(x => {
